...
const UNITS = [
	...
	},
	{
		...
		type_unit = TYPE_UNIT_RANGE,
		name = "Musket Cavalry",
		icon = "res://assets/ui/icon/squad_icon/icon_squad_musket_cavalry.png",
		cooldown = 9.5,
		cost = 35,
		node_name = "",
		scene = "res://scene/units/mounted_range/mounted_range.tscn",
		primary_weapon_scene = "res://scene/weapon/range/musket/musket.tscn",
		secondary_weapon_scene = "",
		projectile_scene = "res://scene/projectile/bullet/bullet.tscn",
		helm = "res://scene/units/uniform/helm_2.png",
		armor = "res://scene/units/uniform/armor_2.png",
		mount_scene = "res://scene/mount/armored_horse/horse.tscn",
		hp = 75.0,
	...
	},
	{
		...
		type_unit = TYPE_UNIT_RANGE,
		name = "Musketeer",
		icon = "res://assets/ui/icon/squad_icon/icon_squad_musketeer.png",
		cooldown = 14.5,
		cost = 25,
		node_name = "",
		scene = "res://scene/units/range/range.tscn",
	...
	},
	{
		...
		type_unit = TYPE_UNIT_RANGE,
		name = "Repeater",
		icon = "res://assets/ui/icon/squad_icon/icon_repeater.png",
		cooldown = 15.0,
		cost = 40,
		node_name = "",
		scene = "res://scene/units/sieges/repeater/repeater.tscn",
		hp = 90.0,
		max_hp = 90.0,
		speed = 1.8,
		attack_damage = 3.0,
	...
	},
	{
		...
		type_unit = TYPE_UNIT_RANGE,
		name = "Onager",
		icon = "res://assets/ui/icon/squad_icon/icon_onager.png",
		cooldown = 18.0,
		cost = 55,
		node_name = "",
		scene = "res://scene/units/sieges/onager/onager.tscn",
		hp = 100.0,
		max_hp = 100.0,
		speed = 1.4,
		attack_damage = 14.0,
	...
	},
	{
		...
		type_unit = TYPE_UNIT_RANGE,
		name = "Howitzer",
		icon = "res://assets/ui/icon/squad_icon/icon_howitzer.png",
		cooldown = 18.0,
		cost = 75,
		node_name = "",
		scene = "res://scene/units/sieges/howitzer/howitzer.tscn",
		hp = 110.0,
		max_hp = 110.0,
		speed = 1.1,
		attack_damage = 24.0,
